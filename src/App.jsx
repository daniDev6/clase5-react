...
function App() {
  ...
  const agregarEncuesta = (nuevaEncuesta) => {
    ...
    console.log('nuevaEncetsa', nuevaEncuesta)
    setListaEncuestas([...listaEncuestas, nuevaEncuesta]);
    console.log('listaEncuestas', listaEncuestas)
  };
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Inicio
          listaEncuestas={listaEncuestas} />} /><Route path="/encuesta/crear" element={<CrearEncuesta
            agregarEncuesta={agregarEncuesta} listaEncuestas={listaEncuestas} />} />
